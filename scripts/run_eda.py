...
def main():
    ...
    notebook_path = os.path.join(base_dir, "ml", "notebooks", "01_dataset_analysis.ipynb")
    ...
    dist_df.plot(kind='bar', color=['#1a5276', '#d35400'], edgecolor='black', width=0.8, figsize=(10, 6))
